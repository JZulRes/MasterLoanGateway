...
export class AnswerService {
    public resourceUrl = SERVER_API_URL + 'masterloanforms/api/answers';
    public resourceSearchUrl = SERVER_API_URL + 'masterloanforms/api/_search/answers';
    ...
    search(req?: any): Observable<EntityArrayResponseType> {
        const options = createRequestOption(req);
        return this.http.get<IAnswer[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
    }
}
