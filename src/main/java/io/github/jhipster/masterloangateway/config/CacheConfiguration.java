...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("MasterLoanGateway");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("MasterLoanGateway");
        ...
        config.getMapConfigs().put("io.github.jhipster.masterloangateway.domain.*", initializeDomainMapConfig(jHipsterProperties));
